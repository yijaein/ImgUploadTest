...
public class MainActivity extends AppCompatActivity implements SmartLoginCallbacks {
    ...
    private Button facebookLoginButton, googleLoginButton, customSigninButton, customSignupButton, logoutButton,back_btn;
...
//로그인 시
    private void refreshLayout() {
        ...
        if (currentUser != null) {
            ...
            logoutButton.setVisibility(View.VISIBLE);//로그아웃 버튼
